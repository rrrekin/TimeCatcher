...
export function useSettings() {
  ...
  const applyTheme = (theme: Theme) => {
    ...
    // Atompunk palette shared
    root.style.setProperty('--verdigris', '#20b59a')
    root.style.setProperty('--mantis', '#c3e04e')
    root.style.setProperty('--asparagus', '#c99456')
    root.style.setProperty('--emerald', '#0f4a4e')
    root.style.setProperty('--aero', '#b4642b')
    root.style.setProperty('--primary', '#0f4a4e')
    root.style.setProperty('--teal', '#0f4a4e')
    root.style.setProperty('--teal-2', '#0a3538')
    root.style.setProperty('--teal-glow', '#20b59a')
    root.style.setProperty('--copper', '#b4642b')
    root.style.setProperty('--copper-2', '#8a4416')
    root.style.setProperty('--brass', '#c99456')
    root.style.setProperty('--uranium', '#c3e04e')
    root.style.setProperty('--rust', '#a6482c')
    root.style.setProperty('--accent', '#c3e04e')
    root.style.setProperty('--accent-soft', 'rgba(195,224,78,.4)')

    if (resolvedTheme === 'dark') {
      root.style.setProperty('--paper', '#1a2426')
      root.style.setProperty('--paper-2', '#141c1e')
      root.style.setProperty('--paper-edge', '#2a3b3e')
      root.style.setProperty('--ink', '#e4dcc4')
      root.style.setProperty('--ink-2', '#c9bc9a')
      root.style.setProperty('--ink-soft', '#8fa29d')
      root.style.setProperty('--cream', '#18272a')
      root.style.setProperty('--bg-primary', '#141c1e')
      root.style.setProperty('--bg-secondary', '#0f1819')
      root.style.setProperty('--text-primary', '#e4dcc4')
      root.style.setProperty('--text-secondary', '#c9bc9a')
      root.style.setProperty('--text-muted', '#8fa29d')
      root.style.setProperty('--border-color', '#2a3b3e')
      root.style.setProperty('--shadow-color', 'rgba(0, 0, 0, 0.4)')
    } else {
      root.style.setProperty('--paper', '#f1e8d6')
      root.style.setProperty('--paper-2', '#e6dcc4')
      root.style.setProperty('--paper-edge', '#c9bc9a')
      root.style.setProperty('--ink', '#16272a')
      root.style.setProperty('--ink-2', '#2c3f43')
      root.style.setProperty('--ink-soft', '#49595c')
      root.style.setProperty('--cream', '#f8f1df')
      root.style.setProperty('--bg-primary', '#f8f1df')
      root.style.setProperty('--bg-secondary', '#f1e8d6')
      root.style.setProperty('--text-primary', '#16272a')
      root.style.setProperty('--text-secondary', '#2c3f43')
      root.style.setProperty('--text-muted', '#49595c')
      root.style.setProperty('--border-color', '#c9bc9a')
      root.style.setProperty('--shadow-color', 'rgba(22, 39, 42, 0.12)')
    }
  }
